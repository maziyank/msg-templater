...
const PersonalTemplate = () => {
  ...
  return (
    <React.Fragment>
      ...
      {user && (
        <Link to={`/main/editor/`}>
          <button className="fixed ring-1 ring-opacity-80 ring-purple-500 right-3 bottom-20 z-20 btn btn-circle btn-md bg-primary shadow-2xl transition ease-in duration-200">
            <PlusIcon />
          </button>
        </Link>
      )}
